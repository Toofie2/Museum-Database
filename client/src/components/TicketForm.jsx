...
const TicketForm = () => {
    ...
    return (
        <div className="ticketForm">
            ...
            <p className="mt-3 leading-loose">Please select an available date for your visit and the amount of tickets you’ll be purchasing.</p>
            ...
            <form className="mt-6">
                ...
                <button className="w-full mt-4 bg-black text-white py-2 px-52 border-black rounded" onClick={handleSubmit}>
                    Purchase
                </button>   
                </Link>
            </form>
