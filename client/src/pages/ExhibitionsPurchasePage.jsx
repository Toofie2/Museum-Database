      ...
      tickets.map((ticket) => {
        ...
        for (let j = 0; j < formData[ticket.type]; j++) {
          permCollectTicketsArr.push({
            ...
            amount_spent:
              customerInfo.is_member && ticket.type == "Adult"
                ? counter < 1
                  ? 0
                  : ticket.price
                : ticket.price,
        ...
        <div className="mt-28 flex justify-between px-16 space-x-24">
                ...
                exhibitionFormData[exhibition.name] > 0 && (
                  ...
                  >
                    <p>
                      ...
                      {exhibitionFormData[exhibition.name]}x)
                    </p>
          ...
          <div className="w-1/2">
            <h1 className="text-2xl font-medium">
              {" "}
              Select the special exhibitions you want to attend (optional){" "}
            </h1>
            <form className="mt-6">
                    ...
                    >
                      ...
                      <div className="flex flex-row">
                        ...
                        <button
                          ...
                          value={exhibitionFormData[exhibition.name]}
                ...
                <div className="text-default-gray">
                  ...
                  <div className="flex flex-row justify-between mt-1">
                    ...
                    <p className="text-red-600">
                      -${ticketTypePricePairs["Adult"].toFixed(2)}
                    </p>
                  </div>
                </div>
              )}
