        ...
        <>
            ...
            <div className = "flex flex-col my-5 space-y-5">
                <div className = "mx-16 flex">
                    <p className="flex w-2/3 text-2xl font-medium items-center">Exhibitions on Display</p>
                    <p className="text-right">Explore our diverse exhibitions, from stunning paintings to captivating illustrations, thought-provoking installations to beautiful sculptures.</p>
                </div>
                <div className="w-full overflow-x-auto"> 
                    <div className="flex gap-5 min-w-max mx-16">
                        {exhibitions.map((exhibition) => (
                            <div key={exhibition.id} className="w-[30rem] flex flex-col space-y-0.5">
                                <img src={exhibition.image_path} alt={exhibition.name} className="w-full h-[18rem] object-cover" />
            ...
            <div className = "flex flex-col my-5 space-y-5">
                <div className = "mx-16 flex">
                    <p className="flex w-2/3 text-2xl font-medium items-center">Museum Map</p>
                    <p className="text-right">Easily locate our galleries, exhibits, facilities, and amenities to plan your visit and make the most of your time here.</p>
                </div>
                <div className="flex mx-16 gap-5">
                    <div className="w-1/2 flex flex-col">
                        <img src={"../src/assets/Floor 1.png"} alt={"Floor 1"} className="h-full object-cover" />
                        <p className="flex text-lg font-medium justify-center">Floor 1</p>
                    </div>
                    <div className="w-1/2 flex flex-col">
                        <img src={"../src/assets/Floor 2.png"} alt={"Floor 2"} className="h-full object-cover" />
