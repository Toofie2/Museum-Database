  ...
  useEffect(() => {
    const fetchExhibitions = async () => {
      try {
        ...
        const sortedExhibitions = response.data.sort((a, b) => new Date(a.end_date) - new Date(b.end_date));
      ...
      <div className="container mx-auto py-10 pb-16">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {Exhibitions.map((Exhibition) => {
            ...
            return (
              <div key={Exhibition.exhibit_id} className="exhibition-item relative bg-white rounded-lg overflow-hidden shadow-lg transition-transform duration-300 transform hover:scale-105 w-auto">
