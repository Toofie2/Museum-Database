...
const PostreviewPage = () => {
    ...
    const handleChange = (e) => {
        ...
        if (['customer_id', 'title', 'feedback', 'rating', 'date_posted'].includes(name)) {
    ...
    return (
        <div className="container mx-auto pb-12 px-4">
            ...
            <form className="bg-white shadow-md rounded-lg p-8">
                ...
                <div className="mb-4">
                    <label className="block text-gray-700 text-lg mb-2" htmlFor="feedback">Feedback</label>
                    <textarea
                        name="feedback"
                ...
                <div className="mb-4">
                    <label className="block text-gray-700 text-lg mb-2" htmlFor="rating">Rating</label>
                    <select
                        name="rating"
                        onChange={handleChange}
                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
