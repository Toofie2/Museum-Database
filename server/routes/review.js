...
router.post('/', (req, res) => {
    ...
    const insertQuery = 'INSERT INTO Review (customer_id, title, feedback, rating, date_posted) VALUES (?, ?, ?, ?, ?)';
    db.query(insertQuery, [customer_id, title, feedback, rating, date_posted], (err, result) => {
        if (err) {
